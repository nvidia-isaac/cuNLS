...
void bind_minimizer(nb::module_& m) {
    nb::class_<cunls::GaussNewtonMinimizer>(m, "GaussNewtonMinimizer",
        ...
        .def("minimize",
             [](cunls::GaussNewtonMinimizer& self,
    ...
    nb::class_<cunls::LevenbergMarquardtMinimizer, cunls::GaussNewtonMinimizer>(m,
