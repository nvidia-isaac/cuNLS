...
void ApplyInformationToJacobians(void *cublas_handle, const float *sqrt_information,
  ...
  THROW_ON_CUBLAS_ERROR(cublasSgemmStridedBatched(
      static_cast<cublasHandle_t>(cublas_handle), CUBLAS_OP_N, CUBLAS_OP_N, jacobian_pitch,
      residual_size, residual_size, &alpha, jacobians, jacobian_pitch, jacobian_stride,
      sqrt_information, residual_size, info_stride, &beta, jacobians, jacobian_pitch,
