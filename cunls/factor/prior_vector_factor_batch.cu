 ...
 * @param state_pointers   Array of device pointers, one per vector, each pointing
 *                     to dim floats of state data.
 ...
 *                     floats, row-major identity per vector), or nullptr to skip.
