...
TEST_F(DenseCholeskySolverTestFixture, SolveDenseSystemAcrossDifferentSizes) {
...
TEST_F(DenseCholeskySolverTestFixture, SolveReturnsFalseForZeroMatrix) {
  DenseCholeskySolver solver;
  constexpr int n = 4;
...
TEST_F(DenseCholeskySolverTestFixture, SolveReturnsFalseForIndefiniteMatrix) {
  DenseCholeskySolver solver;
  constexpr int n = 4;
  const std::vector<float> host_A = {
  ...
  const std::vector<float> rhs_host = {1.0f, 2.0f, 3.0f, 4.0f};
